      ...
      <div className="flex justify-center mt-10">
        <div style={{ fontFamily: "Nunito Sans, sans-serif"}} className="grid sm:grid-cols-1 lg:grid-cols-2">
          ...
          <div className="text-lg">
            <Image className="w-[500px] rounded-3xl mb-5" src={emailImage} alt="" />
                ...
                <div className="grid grid-flow-col gap-4">
                  <div>
                    <a href="https://www.facebook.com/tamzid.ull.monir512">
                      <Image style={{ width: "30px" }} src={facebook} alt="" />
                    </a>
                  </div>

                  <div>
                    <a href="https://www.instagram.com/Tamzid_Ull_Monir/">
                      <Image style={{ width: "30px" }} src={instagram} alt="" />
                    </a>
                  </div>

                  <div>
                    <a href="https://www.linkedin.com/in/tamzid-monir-96b163260/">
                      <Image style={{ width: "30px" }} src={linkedin} alt="" />
                    </a>
                  </div>
