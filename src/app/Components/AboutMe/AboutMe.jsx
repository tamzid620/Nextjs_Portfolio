...
const AboutMe = () => {
    return (
      ...
      <div className='grid lg:grid-cols-2 md:grid-cols-2 sm: grid-cols-1 gap-5 items-center justify-center pt-[40px]'>
        ...
        {/* discription div  */}
        <div>
            <h1 className='font-bold text-xl text-purple-800'>I’m a Developer</h1>
            <h2 className='font-bold text-3xl'>I Can Develope Anything <br /> You Want</h2>
            <p className='leading-8 text-lg'>Hello! I’m a web developer with 2 years of experience, specializing in creating dynamic and user-friendly websites. My expertise spans HTML, CSS, Next.js, React.js, JavaScript, Express.js, and MongoDB. I’m passionate and dedicated to every step of the design process, from initial discussion to final execution. Let’s make your project a success together!</p>
        </div>
      </div>
        </div>
    );
